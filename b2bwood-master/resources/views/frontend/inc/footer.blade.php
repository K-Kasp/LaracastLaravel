        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 pt-4">
                <div class="text-center text-md-left">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <a class="text-white" rel="noopener" target="_blank" href="/page/careers/">
                                {{ translate('Careers') }} </a>
                        </li>
                        {{-- <li class="mb-2">
                        ...
                        <li class="mb-2">
                            <a class="text-white" rel="noopener" target="_blank" href="/page/contacts/">
            ...
            <div class="col-lg-3 col-md-3 pt-4">
                <div class="text-center text-md-left">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a class="text-white" rel="noopener" target="_blank" href="{{ route('shops.create') }}">
                        ...
                        <li class="mb-2">
                            <a class="text-white" rel="noopener" href="/page/pricing/">
                                {{ translate('Pricing and Club Memberships') }} </a>
                        </li>
                        <li class="mb-2 d-none">
                            <a class="text-white" rel="noopener" target="_blank" href="/page/verification/">
            ...
            <div class="col-lg-3 col-md-3 pt-4">
                <div class="text-center text-md-left">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a class="text-white" rel="noopener" href="{{ route('shops.create') }}">
                                {{ translate('Create a Profile') }} </a>
                        </li>
                        <li class="mb-2">
                            <a class="text-white" rel="noopener" target="_blank" href="#">
                                {{ translate('Knowledge Center') }} </a>
                        </li>
                        <li class="mb-2">
                            <a class="text-white" rel="noopener" target="_blank" href="#"> {{ translate('Privacy') }}
                            </a>
                        </li>
                    </ul>
        ...
        @if (Auth::check())
            ...
            @else
                <a href="javascript:void(0)" class="text-reset flex-grow-1 text-center py-2 mobile-side-nav-thumb"
                    ...
                    <span class="avatar avatar-sm d-block mx-auto">
                        <img class="img-fluid" style="object-fit:contain;" src="{{ auth()->user()->shop->get_company_logo() }}"
