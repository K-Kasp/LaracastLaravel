...
@section('company_profile')
        ...
        @php
            ...
            if ($review_relationships->count() > 0) {
                ...
                $five_stars = $shop->reviews()->whereHas('review', function($review) {
                    return $review->where('rating', 5);
                })->count();
                $four_stars = $shop->reviews()->whereHas('review', function($review) {
                    return $review->where('rating', 4);
                })->count();
                $three_stars = $shop->reviews()->whereHas('review', function($review) {
                    return $review->where('rating', 3);
                })->count();
                $two_stars = $shop->reviews()->whereHas('review', function($review) {
                    return $review->where('rating', 2);
                })->count();
                $one_stars = $shop->reviews()->whereHas('review', function($review) {
                    return $review->where('rating', 1);
                })->count();
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="pl-lg-4">
                        ...
                        @php $review = $relationship->review; @endphp
                        <div class="border-bottom pb-4 mb-4">
                            <!-- Review Rating -->
                            ...
                            <div class="text-body font-size-1 mb-2">
                                <span class="text-dark font-weight-bold"><a href="#">{{$relationship->creator->name}}</a></span>
                                @if ($review->status == 1)
