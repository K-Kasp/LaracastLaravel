                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                    ...
                                    <a href="{{route('sellers.documentgallery', encrypt($seller->id))}}" class="dropdown-item">
                                      {{translate('Gallery and Documents')}}
                                    </a>
                                    <a href="{{route('sellers.payment_history', encrypt($seller->id))}}" class="dropdown-item">
                                      {{translate('Payment History')}}
                                    </a>
                                    <a href="{{route('sellers.attribute_history', encrypt($seller->id))}}" class="dropdown-item">
