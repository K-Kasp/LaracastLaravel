                                    ...
                                    <div class="aiz-file-box">
                                        <div class="dropdown-file" >
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="{{route('sellers.documentgallery.edit', $thumbnail->group->id)}}" class="dropdown-item" data-id="">
                        ...
                        <tbody>
                            @foreach($seller->documents as $index => $document)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('sellers.documentgallery.edit', $document->group->id)}}" title="{{ translate('Edit') }}">
