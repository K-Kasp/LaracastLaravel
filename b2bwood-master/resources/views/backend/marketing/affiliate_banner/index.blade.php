...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		...
		<div class="col-md-6 text-md-right">
			<a href="{{ route('affiliate_banner.create') }}" class="btn btn-circle btn-info">
            ...
            <tbody>
                @foreach($affiliate_banners as $key => $affiliate_banner)
                    <tr>
						...
						<td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('affiliate_banner.edit', ['id'=>$affiliate_banner->id] )}}" title="{{ translate('Edit') }}">
                                <i class="las la-edit"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('affiliate_banner.destroy', $affiliate_banner->id)}}" title="{{ translate('Delete') }}">
