    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
                ...
                @if(Auth::user()->user_type == 'admin')
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('attributes.slug_index', ['slug' => 'product'])}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['attributes.index','attributes.create','product.attributes.edit'])}}">
                ...
                @if((Auth::user()->user_type == 'admin' || in_array('9', json_decode(Auth::user()->staff->role->permissions))) && \App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('attributes.slug_index', ['slug' => 'sellers'])}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['attributes.index','attributes.create','seller.attributes.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Attribute')}}</span>
                                </a>
                            </li>
                        </ul>
            ...
            <!--Blog System-->
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('11', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('affiliate_banner.index') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['affiliate_banner.index', 'affiliate_banner.create', 'affiliate_banner.edit'])}}">
            ...
            <!-- Website Setup -->
                ...
                {{--  Activity of user --}}
                <li class="aiz-side-nav-item">
                    {{--  {{ areActiveRoutes(['categories.index', 'categories.create', 'categories.edit'])}} add this in class below so it would highlight the route  --}}
                    <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['activities.index', 'activities.user.index'])}} ">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{route("activities.index")}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('All Activities')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route("activities.user.index")}}" class="aiz-side-nav-link">
