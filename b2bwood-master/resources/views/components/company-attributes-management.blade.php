                ...
                @foreach ($attributes as $attribute)
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            @endif
                            @if ($attribute->type == 'plain_text' || $attribute->type == 'number')
                                @php
                                    $value = "";
                                ...
                                @endphp
                                <input type="{{ $attribute->type == 'plain_text' ? 'text' : 'number' }}" placeholder="{{ translate('Default Value')}}" id="{{ 'plain_text_'. $attribute->id }}" name="{{ $attribute->id }}" class="form-control" value="{{ $value }}" step="any">
                            @endif
