...
class HomeController extends Controller
{
    ...
    {
        $user = Auth::user();
        $content_type = 'App\\' . $user->user_type;
            ...
            if ($value != null) {
                ...
                if ($attribute->type != "checkbox") {
                    if ($attribute_relationship == null) {
                        ...
                        $attribute_relationship->subject_type = "App\Seller";
    ...
    public function search(Request $request, $category_id = null, $brand_id = null)
    {
        ...
        return view('frontend.product_listing', compact('products', 'shops', 'product_count', 'company_count', 'query', 'category_id', 'brand_id', 'sort_by', 'seller_id', 'content'));
    }
